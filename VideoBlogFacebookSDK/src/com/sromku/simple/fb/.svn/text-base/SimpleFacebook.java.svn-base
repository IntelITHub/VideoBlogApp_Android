...
//		} else {
//			// construct a new session (there are different ways to do this,
//			// this is how I do it because I need to pass the FACEBOOK_API_KEY
//			// programmatically).
//			// session = new
//			// Session.Builder(MyApp.getInstance()).setApplicationId(Constants.FACEBOOK_API_KEY).build();
//			session = new Session.Builder(mActivity.getApplicationContext()).setApplicationId(mConfiguration.getAppId()).build();
//
