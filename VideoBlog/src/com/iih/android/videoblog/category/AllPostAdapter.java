...
import com.iih.android.videoblog.category.SelectedCatListAdapter.ViewHolder;
...
public class AllPostAdapter extends BaseAdapter {
	...
	// Context ctx = null;
		...
		public AllPostAdapter(Activity activty, ArrayList<String> username,
				ArrayList<String> category, ArrayList<String> titlelist,
				ArrayList<String> imagelist, ArrayList<String> likelist,
				ArrayList<String> commentList, ArrayList<Object> tempData,ArrayList<String> Description) {
