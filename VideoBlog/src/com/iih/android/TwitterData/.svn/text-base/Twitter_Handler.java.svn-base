...
public class Twitter_Handler {
	...
	public Long getUID() {
		return mSession.getUID();
	}

	public String getUProPic() {
		return mSession.getUProPic();
	}
...
//					tUserDesc=user.getDescription();
//					tUID=user.getId();
//					tProPic=user.getMiniProfileImageURL();
//					tUName=user.getName();
//					tUScreenName=user.getScreenName();

					mSession.storeAccessToken(mAccessToken, user.getName(),user.getDescription(),user.getId(),user.getMiniProfileImageURL(),user.getScreenName());
