...
public class FacebookDialog {
	 ...
	 * are added, these flags may be passed to
	...
	private static int getProtocolVersionForNativeDialog(Context context,
		...
		return NativeProtocol.getLatestAvailableProtocolVersion(context,
				requiredVersion);
	}
	...
	private abstract static class Builder<CONCRETE extends Builder<?>> {
		...
		boolean handleCanPresent() {
			return getProtocolVersionForNativeDialog(activity,
					MIN_NATIVE_SHARE_PROTOCOL_VERSION) != NativeProtocol.NO_PROTOCOL_AVAILABLE;
		}
	...
	public static class ShareDialogBuilder extends Builder<ShareDialogBuilder> {
		...
		@Override
		boolean handleCanPresent() {
			return canPresentShareDialog(activity,
		...
		Intent handleBuild(Bundle extras) {
			...
			Intent intent = NativeProtocol.createPlatformActivityIntent(
					activity, NativeProtocol.ACTION_FEED_DIALOG,
	 ...
	 * installed, so it should only be used if {@link
	 * FacebookDialog.checkCanPresentOpenGraphDialog();} indicates the
	 * capability is available.
	 */
	public static class OpenGraphActionDialogBuilder extends
			Builder<OpenGraphActionDialogBuilder> {
		 ...
		 * @return this instance of the builder
		 */
		public OpenGraphActionDialogBuilder setDataErrorsFatal(
		 ...
		 * @return this instance of the builder
		 */
		public OpenGraphActionDialogBuilder setImageAttachmentsForAction(
				List<Bitmap> bitmaps) {
		 ...
		 * @return this instance of the builder
		 */
		public OpenGraphActionDialogBuilder setImageAttachmentFilesForAction(
		 ...
		 * @return this instance of the builder
		 */
		public OpenGraphActionDialogBuilder setImageAttachmentsForObject(
				String objectProperty, List<Bitmap> bitmaps) {
		 ...
		 * @return this instance of the builder
		 */
		public OpenGraphActionDialogBuilder setImageAttachmentFilesForObject(
				String objectProperty, List<File> bitmapFiles) {
		...
		Intent handleBuild(Bundle extras) {
			...
			Intent intent = NativeProtocol.createPlatformActivityIntent(
					activity, NativeProtocol.ACTION_OGACTIONPUBLISH_DIALOG,
					protocolVersion, extras);
		...
		private OpenGraphActionDialogBuilder addImageAttachment(
		...
		private OpenGraphActionDialogBuilder addImageAttachment(
				String imageName, File attachment) {
			if (imageAttachmentFiles == null) {
